...
picArray.forEach(pic => {
  ...
  newArticleElement.classList.add('card');

  const h2Element = document.createElement('h2');
  h2Element.textContent = pic.title;
  ...
  sectionElement.appendChild(newArticleElement);
});